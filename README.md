...
[이스트캠프] 가디언즈 정보보호 및 인프라 관리 10기 3차 팀 프로젝트 팔로팔로미
...
| 조경익 | 서비스 인프라 담당 | 웹·DB 서버 VM 구성, 취약 계정/권한 설계, 발표 |
| 김유선 | 보안 인프라 담당 | pfSense → Suricata → ModSecurity 배치·검증 |
| 이찬근 | 보안관제·악성코드 분석 | Suricata/WAF 룰 설정 및 탐지·차단 증빙, 악성코드 정적 분석, 발표 PPT 제작 |
| 정슬기 | 보안관제(SIEM) 담당 | ELK Stack 기반 로그 통합 수집·정규화 및 대시보드 시각화 |
